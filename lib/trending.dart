  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Card(
        ...
        child: Stack(
          children: <Widget>[
            Image.network(urlfromImage(trackInfo["videoThumbnails"], "medium")),
            Positioned(
                right: 0,
                left: 0,
                bottom: 0,
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        height: Theme.of(context).textTheme.subhead.fontSize+5,
                        child: Text(
                          trackInfo["title"],
